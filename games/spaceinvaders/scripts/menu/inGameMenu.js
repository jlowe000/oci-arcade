...
var inGameMenu = (function() {
    ...
    var btn = new Button(mapWidth/2 - w/2,mapHeight - h/2,w,h, function() {
        showMainMenu();
        vcr.onHudDisable();
    });
    btn.setText("MENU");
    btn.setFont(menuSize+"px ArcadeR","#FFF");

    // confirms a menu action
    var confirmMenu = new Menu("QUESTION?",2*menuSize,5*menuSize,mapWidth-4*menuSize,3*menuSize,menuSize,menuSize+"px ArcadeR", "#EEE");
    ...
    // regular menu
    var menu = new Menu("PAUSED",2*menuSize,5*menuSize,mapWidth-6*menuSize,3*menuSize,menuSize,menuSize+"px ArcadeR", "#EEE");
    ...
    // practice menu
    var practiceMenu = new Menu("PAUSED",2*menuSize,5*menuSize,mapWidth-6*menuSize,3*menuSize,menuSize,menuSize+"px ArcadeR", "#EEE");
    ...
    // cheats menu
    var cheatsMenu = new Menu("CHEATS",2*menuSize,5*menuSize,mapWidth-4*menuSize,3*menuSize,menuSize,menuSize+"px ArcadeR", "#EEE");
